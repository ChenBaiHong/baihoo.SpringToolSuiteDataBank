...
public class UserspaceController {
	...
	@PreAuthorize("authentication.name.equals(#username)") 
	public String saveProfile(String username , @Valid User user) throws Exception {
	...
	@PreAuthorize("authentication.name.equals(#username)")
	public ResponseEntity<Response> saveAvatar(@PathVariable("username") String username , @Valid User user) throws Exception{
